...
const trustFeatures = [
  {
    ...
    desc: 'All documents are encrypted and never shared with third parties.',
    iconPath:
  ...
  },
  {
    ...
    desc: 'Start your appeal immediately — no sign-up, no personal info needed.',
  ...
  },
  {
    ...
    desc: 'Get your denial explained and appeal letter generated in under 5 minutes.',
  ...
  },
  {
    ...
    title: 'Legally Sound',
    desc: 'Appeal letters cite 44 CFR § 206.115 and relevant FEMA regulations.',
    iconPath:
...
export default function HomePage() {
  return (
    <main id="main-content" className="flex flex-col">
      ...
      {/* ── Hero ── */}
      <section className="relative pt-24 md:pt-32 pb-20 overflow-hidden bg-gradient-to-br from-[#1E3A5F] via-[#1E3A5F] to-[#0F172A] text-white">
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-6">
            <Link
              href="/upload"
              className="inline-flex items-center justify-center gap-2 bg-white text-[#1E3A5F] font-extrabold text-base px-8 py-4 rounded-2xl shadow-xl hover:bg-blue-50 transition-all duration-200 hover:shadow-2xl active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-blue-900 w-full sm:w-auto"
            >
              Start Your Appeal
            ...
            <Link
              href="/emergency"
              className="inline-flex items-center justify-center gap-2 border-2 border-white/40 text-white font-semibold text-base px-6 py-4 rounded-2xl hover:bg-white/10 transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-blue-900 w-full sm:w-auto"
            >
        ...
        {/* Stats bar */}
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-14">
      ...
      <section id="how-it-works" aria-labelledby="how-it-works-heading" className="bg-white py-20 md:py-28">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 id="how-it-works-heading" className="text-3xl md:text-4xl font-extrabold text-slate-900 mb-3">
              How it works
            </h2>
            <p className="text-slate-500 text-lg max-w-lg mx-auto">
              Three simple steps to submit your appeal today
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-6 md:gap-8">
            {steps.map(({ num, bg, border, numBg, iconColor, title, desc, iconPath }) => (
              <div key={num} className={`bg-white border ${border} rounded-2xl p-7 shadow-sm hover:shadow-md transition-shadow`}>
                ...
                <span className={`inline-flex items-center justify-center w-6 h-6 rounded-full ${numBg} text-white text-xs font-bold mb-4`}>
                  {num}
                </span>
      ...
      <section aria-labelledby="trust-heading" className="bg-slate-50 py-20 md:py-28">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 id="trust-heading" className="text-3xl md:text-4xl font-extrabold text-slate-900 mb-3">
              Built for trust &amp; simplicity
            </h2>
            <p className="text-slate-500 text-lg max-w-lg mx-auto">
              We designed AppealKit to be the easiest, safest way to fight your FEMA denial
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 id="deadline-heading" className="text-3xl md:text-4xl font-extrabold text-slate-900 mb-4">
                Don&apos;t miss your{' '}
                <span className="text-red-600">60-day deadline</span>
              </h2>
              <p className="text-slate-600 text-lg leading-relaxed mb-6">
                You have <strong>60 days</strong> from the date on your FEMA letter to submit an appeal. After that, you may{' '}
                <strong>permanently lose your right to appeal</strong>.
              </p>
              <div className="bg-amber-50 border border-amber-200 rounded-2xl p-5 flex gap-4 items-start mb-8">
                ...
                <div>
                  ...
                  <p className="text-amber-800 text-sm leading-relaxed">
                    Upload your letter now and we&apos;ll calculate your exact deadline, track it for you, and send reminders as it approaches.
                  </p>
                </div>
              </div>
              <div className="flex flex-col sm:flex-row gap-3">
                <Link
                  href="/upload"
                  className="inline-flex items-center justify-center gap-2 bg-red-600 hover:bg-red-700 text-white font-bold px-6 py-3.5 rounded-2xl shadow-md hover:shadow-lg transition-all active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2"
                >
                ...
                <Link
                  href="/tracker"
                  className="inline-flex items-center justify-center border-2 border-slate-300 text-slate-700 hover:border-slate-400 hover:bg-slate-50 font-semibold px-6 py-3.5 rounded-2xl transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 focus-visible:ring-offset-2"
                >
                  View My Documents
                </Link>
              </div>
                  ...
                  <div key={label} className="bg-white rounded-xl p-4 border border-slate-100">
                    ...
                    <div className="w-full bg-slate-100 rounded-full h-1.5">
                      <div
                        ...
                        style={{ width: `${Math.min(100, Math.max(2, (days / 60) * 100))}%` }}
                        aria-hidden="true"
                      />
                    </div>
                  </div>
      ...
      {/* ── Thousands of survivors / community CTA ── */}
